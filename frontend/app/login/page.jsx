...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.message || "Login failed. Please verify your credentials and try again.")
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center items-center bg-[#00447c] text-white p-12">
        <div className="max-w-md">
          ...
          <p className="mb-8 text-gray-200">
            Access your organization's knowledge base, research materials, and resources 
            through our secure enterprise platform.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              <svg className="h-6 w-6 text-blue-300 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-none shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-5">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-11 bg-[#00447c] hover:bg-[#003366] transition-colors" 
                  disabled={loading}
                >
                  {loading ? (
                    <>
          ...
          <div className="mt-8 text-center text-xs text-gray-500">
            ...
            <div className="mt-2 flex justify-center space-x-4">
              ...
              <Link href="/help" className="hover:text-gray-700 hover:underline">Help Center</Link>
            </div>
          </div>
        </div>
      </div>
