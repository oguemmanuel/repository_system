...
const translations = {
  en: {
    ...
    centralizedStorageDesc:
      "Store all academic resources in one secure location for easy access.",
    advancedSearch: "Advanced Search",
    advancedSearchDesc:
      "Find resources quickly with our powerful search functionality.",
  ...
  fr: {
    ...
    updatedRegularly:
      "Mis à jour régulièrement avec les dernières ressources académiques",
    keyResources: "Ressources clés disponibles",
    pastExams: "Questions d'examens précédents",
    pastExamsDesc:
      "Accédez aux questions d'examen des semestres précédents pour une meilleure préparation.",
    thesesProjects: "Thèses et projets",
    thesesProjectsDesc:
      "Parcourez les projets de fin d'études et les thèses pour l'inspiration de recherche.",
    easySubmission: "Soumission facile",
    easySubmissionDesc:
      "Soumettez votre travail en toute sécurité avec notre processus de téléchargement rationalisé.",
    exploreResources: "Explorer les ressources",
    browseRepository: "Parcourir le dépôt",
    exploreCollection:
      "Explorez notre collection de ressources académiques librement.",
    ...
    featuresSubtitle:
      "Notre système fournit une solution complète pour la gestion des ressources académiques à l'UCG.",
    ...
    advancedSearchDesc:
      "Trouvez rapidement des ressources avec notre fonctionnalité de recherche puissante.",
    ...
    fileManagementDesc:
      "Téléchargez, téléchargez et organisez des fichiers facilement.",
    footerText:
      "Une plateforme centralisée pour stocker, organiser et accéder aux ressources académiques.",
  ...
  es: {
    ...
    updatedRegularly:
      "Actualizado regularmente con los últimos recursos académicos",
    keyResources: "Recursos clave disponibles",
    pastExams: "Exámenes pasados",
    pastExamsDesc:
      "Acceda a preguntas de exámenes de semestres anteriores para una mejor preparación.",
    thesesProjects: "Tesis y proyectos",
    thesesProjectsDesc:
      "Explore proyectos de fin de año y tesis para inspiración en investigación.",
    easySubmission: "Envío fácil",
    easySubmissionDesc:
      "Envíe su trabajo de forma segura con nuestro proceso de carga simplificado.",
    exploreResources: "Explorar recursos",
    browseRepository: "Explorar repositorio",
    exploreCollection:
      "Explore nuestra colección de recursos académicos libremente.",
    ...
    featuresSubtitle:
      "Nuestro sistema proporciona una solución integral para gestionar recursos académicos en UCG.",
    centralizedStorage: "Almacenamiento centralizado",
    centralizedStorageDesc:
      "Almacene todos los recursos académicos en una ubicación segura para un acceso fácil.",
    advancedSearch: "Búsqueda avanzada",
    advancedSearchDesc:
      "Encuentre recursos rápidamente con nuestra potente funcionalidad de búsqueda.",
    ...
    footerText:
      "Una plataforma centralizada para almacenar, organizar y acceder a recursos académicos.",
    copyright:
      "© 2024 Universidad Católica de Ghana. Todos los derechos reservados.",
  ...
  pt: {
    ...
    updatedRegularly:
      "Atualizado regularmente com os últimos recursos acadêmicos",
    keyResources: "Recursos-chave disponíveis",
    pastExams: "Questões de exames passados",
    pastExamsDesc:
      "Acesse questões de exames de semestres anteriores para uma melhor preparação.",
    thesesProjects: "Teses e projetos",
    thesesProjectsDesc:
      "Navegue por projetos de final de ano e teses para inspiração em pesquisa.",
    easySubmission: "Submissão fácil",
    easySubmissionDesc:
      "Envie seu trabalho com segurança com nosso processo de upload simplificado.",
    exploreResources: "Explorar recursos",
    browseRepository: "Navegar no repositório",
    exploreCollection:
      "Explore nossa coleção de recursos acadêmicos livremente.",
    ...
    featuresSubtitle:
      "Nosso sistema fornece uma solução abrangente para gerenciar recursos acadêmicos na UCG.",
    centralizedStorage: "Armazenamento centralizado",
    centralizedStorageDesc:
      "Armazene todos os recursos acadêmicos em um local seguro para fácil acesso.",
    advancedSearch: "Pesquisa avançada",
    advancedSearchDesc:
      "Encontre recursos rapidamente com nossa poderosa funcionalidade de pesquisa.",
    userManagement: "Gerenciamento de usuários",
    userManagementDesc:
      "Controle de acesso baseado em funções para alunos, professores e administradores.",
    fileManagement: "Gerenciamento de arquivos",
    fileManagementDesc:
      "Faça upload, download e organize arquivos com facilidade.",
    footerText:
      "Uma plataforma centralizada para armazenar, organizar e acessar recursos acadêmicos.",
    copyright:
      "© 2024 Universidade Católica de Gana. Todos os direitos reservados.",
  ...
  de: {
    ...
    updatedRegularly:
      "Regelmäßig mit den neuesten akademischen Ressourcen aktualisiert",
    keyResources: "Verfügbare Schlüsselressourcen",
    pastExams: "Vergangene Prüfungsfragen",
    pastExamsDesc:
      "Zugriff auf Prüfungsfragen aus früheren Semestern zur besseren Vorbereitung.",
    thesesProjects: "Abschlussarbeiten & Projekte",
    thesesProjectsDesc:
      "Durchsuchen Sie Jahresprojekte und Abschlussarbeiten für Forschungsinspiration.",
    easySubmission: "Einfache Einreichung",
    easySubmissionDesc:
      "Reichen Sie Ihre Arbeit sicher mit unserem optimierten Upload-Prozess ein.",
    exploreResources: "Ressourcen erkunden",
    browseRepository: "Repository durchsuchen",
    exploreCollection:
      "Entdecken Sie unsere Sammlung akademischer Ressourcen frei.",
    ...
    centralizedStorageDesc:
      "Speichern Sie alle akademischen Ressourcen an einem sicheren Ort für einfachen Zugriff.",
    advancedSearch: "Erweiterte Suche",
    advancedSearchDesc:
      "Finden Sie schnell Ressourcen mit unserer leistungsstarken Suchfunktion.",
    userManagement: "Benutzerverwaltung",
    userManagementDesc:
      "Rollenbasierte Zugriffskontrolle für Studenten, Fakultät und Administratoren.",
    fileManagement: "Dateiverwaltung",
    fileManagementDesc:
      "Laden Sie Dateien hoch, herunter und organisieren Sie sie mit Leichtigkeit.",
    footerText:
      "Eine zentrale Plattform zum Speichern, Organisieren und Zugreifen auf akademische Ressourcen.",
                ...
                {loading ? (
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        className="relative h-12 w-12 rounded-full hover:scale-105 transition-transform duration-200"
                      >
                    ...
                    <DropdownMenuContent
                      className="w-72 bg-white/95 backdrop-blur-xl border border-white/20 shadow-xl shadow-slate-500/10 rounded-2xl"
                      align="end"
                      forceMount
                    >
                      <DropdownMenuLabel>
                      ...
                      <DropdownMenuGroup>
                        <DropdownMenuItem className="flex flex-col items-start p-4 hover:bg-blue-50/50 rounded-xl mx-2 my-1">
                          ...
                          <span className="text-sm font-medium truncate w-full text-slate-700">
                            {user.email}
                          </span>
                        </DropdownMenuItem>
                        {user.indexNumber && (
                      ...
                      <DropdownMenuSeparator className="bg-gradient-to-r from-transparent via-slate-200 to-transparent" />
                      <DropdownMenuItem
                        className="cursor-pointer text-red-600 hover:text-red-700 hover:bg-red-50/50 p-4 rounded-xl mx-2 my-1 group"
                  ...
                  <CardContent className="p-0">
                    <div className="divide-y divide-slate-100">
                      ...
                      <div className="flex items-center gap-6 p-8 hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-indigo-50/30 transition-all duration-300 group cursor-pointer">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-purple-700 transition-colors duration-300">
                            {t.easySubmission}
                          </h3>
                          <p className="text-slate-600 font-medium">
                            {t.easySubmissionDesc}
                          </p>
                        </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className={`h-2 w-full bg-gradient-to-r ${feature.bgColor}`}
                  ></div>
                  <CardContent className="p-8">
                    <div
                      className={`bg-gradient-to-br ${feature.bgColor} rounded-2xl p-4 inline-flex mb-6 shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300`}
                    >
                      {feature.icon}
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <Link
                    href="/"
                    className="text-slate-300 hover:text-white block transition-all duration-300 hover:translate-x-2 font-medium"
                  >
                    {t.home}
                  </Link>
                  <Link
              ...
              <div className="space-y-6">
                <h3 className="font-bold text-xl mb-6 text-white">{t.legal}</h3>
                <div className="space-y-4">
                  <Link
                    href="/terms"
                    className="text-slate-300 hover:text-white block transition-all duration-300 hover:translate-x-2 font-medium"
